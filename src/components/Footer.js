...
const Fotter = ({footer}) => {
  return (
    <>    <div className='PreFotter'>
    <div>
        {repeatIcon}
        <p> <b>Hassle-free replacement</b>10-days easy replacement policy om mi.com</p>
    </div>
      <div>
        {shieldIcon}<p> <b>100% secure payments </b><br/>We Support Cards,Wallets,EMI and Cod</p>
      </div>
      <div>
        {mapIcon}<p> <b>100% secure payments </b><br/>We Support Cards,Wallets,EMI and Cod</p>
      </div>
    </div>
    <div className='PreFotter-2'>
     <div><p>LET'S STAY IN TOUCH</p><span style={{marginRight:"100px"}}>Get Update on sales specail and more</span></div>
     <div>
        <div>
            <input type='email' name='email' placeholder='EnterEmail Adress'/>
            <button>></button>
        </div>
        <span>Thanks. You're on our email for specail offers.</span>
     </div>
     <div>
        <p>FOLLOW MI</p>
        <span>We want to her from you!</span>
     </div>
     <div>
    ...
    <div className="footerBorder">
       <div> Copyright By Huraira © 2015 - 2023 . All Rights Reserved</div>
        </div>
    </>
